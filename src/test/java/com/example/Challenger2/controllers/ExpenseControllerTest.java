...
class ExpenseControllerTest {
    ...
    void update1() throws Exception {
        ...
        var response = mvc.perform(put("/expenses/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dtoJacksonTester.write(dto).getJson()))
                .andReturn().getResponse();
    ...
    void update3() throws Exception {
        ...
        var response = mvc.perform(put("/expenses/{id}", id)
                        ...
                        .content(dtoJacksonTester.write(dto).getJson()))
                .andReturn().getResponse();
        var response2 = mvc.perform(put("/expenses/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dtoJacksonTester.write(dto2).getJson()))
                .andReturn().getResponse();
        var response3 = mvc.perform(put("/expenses/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dtoJacksonTester.write(dto3).getJson()))
                .andReturn().getResponse();
        var response4 = mvc.perform(put("/expenses/{id}", id)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(dtoJacksonTester.write(dto4).getJson()))
                .andReturn().getResponse();
    ...
    @Test
    @Transactional
    @DisplayName("Must return 204 if expense is deleted")
    void delete1() throws Exception {
        Long id = 1L;

        var response = mvc.perform(delete("/expenses/{id}", id)).andReturn().getResponse();
    ...
    @Test
    @Transactional
    @DisplayName("Must return 404 if expense does not exists")
    ...
    @Test
    @Transactional
    @DisplayName("You must return code 200 and all expenses with the date provided")
    void findByYearAndMonth() throws Exception {
        Integer year = 1999;
        Integer month = 2;

        var response = mvc.perform(get("/expenses/{year}/{month}", year, month)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn().getResponse();
    ...
    @Test
    @Transactional
    @DisplayName("Must return code 404 if the expense does not exist on the indicated date")
